...
The update fetches from the site's own `origin` remote. A site the app created points at `WordPress/wordpress-develop`; a site you added from an existing checkout of a fork keeps fetching from that fork.
